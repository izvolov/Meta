//
//  meta/types/comparison/implementation/greater.hpp
//
//  Дмитрий Изволов.
//  11 февраля 2012 года.
//

#ifndef META_TYPES_COMPARISON_IMPLEMENTATION_GREATER_HPP
#define META_TYPES_COMPARISON_IMPLEMENTATION_GREATER_HPP
...
namespace meta
{
    namespace impl
    {
        ...
        struct greater <integer<Left>, integer<Right>>
        {
            static constexpr bool value = Left > Right;
        };
        
        template <int Numerator1, int Denominator1, int Numerator2, int Denominator2>
        struct greater <rational<Numerator1, Denominator1>, rational<Numerator2, Denominator2>>
        {
...
#endif // META_TYPES_COMPARISON_IMPLEMENTATION_GREATER_HPP
