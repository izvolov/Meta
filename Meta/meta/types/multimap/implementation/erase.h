//
//  meta/types/multimap/implementation/erase.h
//
//  Дмитрий Изволов.
    ...
    namespace multimap
    {
        namespace impl
        {
            ...
            struct erase <node<Left, void, CurrentValue>, Key>
            {
                ...
                // Если справа пусто, а слева было что-то удалено, то это значит, что и слева теперь
                // пусто (высота левой ветви не может быть больше единицы, поскольку дерево уже
                // отбалансировано при построении), поэтому балансировать не нужно.
            ...
            struct erase <node<Left, void, pair<Key, Mapped>>, Key>
            {
                ...
                // В левом дереве ничего не изменилось, можно не балансировать.
            };
            ...
            struct erase <node<void, Right, CurrentValue>, Key>
            {
                ...
                // Если слева пусто, а справа было что-то удалено, то это значит, что и справа теперь
                // пусто (высота правой ветви не может быть больше единицы, поскольку дерево уже
                // отбалансировано при построении), поэтому балансировать не нужно.
                // Если же справа ничего не было удалено (ключ попросту не был найден), то тем более
                // балансировать ничего не надо.
            };
            ...
            struct erase <node<void, Right, pair<Key, Mapped>>, Key>
            {
                ...
                // В правом дереве ничего не изменилось, балансировать не нужно.
            };
